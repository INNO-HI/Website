...
import kepcoImgSrc from '@/assets/partners/kepco-mcs.png';
import yangcheonImgSrc from '@/assets/partners/yangcheon.jpg';
import ssisImgSrc from '@/assets/partners/bodymap.png';
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 이미지 영역 */}
        {ref_.image && (
          <div className="w-full h-[220px] sm:h-[300px] bg-[#F8F9FA] rounded-t-2xl overflow-hidden">
            <img
              src={ref_.image}
        ...
        <div className="p-6 sm:p-10">
          ...
          <p className="text-[15px] text-[#333D4B] leading-[1.85] whitespace-pre-line">
