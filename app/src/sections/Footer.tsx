        ...
        <div className="border-t border-[#F2F4F6] py-6 sm:py-8 lg:py-10">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 mt-5">
            <div className="flex items-center gap-4">
              ...
              <Link to="/privacy" className="text-[13px] text-[#4E5968] font-semibold hover:text-[#448CFF] transition-colors">
                {lang === 'ko' ? '개인정보 처리방침' : 'Privacy Policy'}
              </Link>
            </div>
            <p className="text-[14px] text-[#D1D6DB] font-light tracking-wide">
              {lang === 'ko' ? '더 깊은 지능, 가장 높은 존중.' : 'Deepest Intelligence, Highest Respect.'}
            </p>
          </div>
        </div>
